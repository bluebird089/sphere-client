...
const Review = () => {
    ...
    return (
        <div className="container mx-auto py-5 md:py-10 px-3 md:px-0">
            <div className={`bg-gray-100 ${darkMode && 'bg-opacity-20'} rounded-3xl`}>
                ...
                <div className='grid md:grid-cols-3 gap-5 p-3 md:p-10'>
                    ...
                    <div className={`bg-white ${darkMode && 'bg-opacity-90'} flex flex-col items-center gap-5 rounded-3xl p-5`}>
