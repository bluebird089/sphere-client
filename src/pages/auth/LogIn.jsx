...
const LogIn = () => {
    ...
    return (
        ...
        <div className="py-3 px-3 md:px-0 container mx-auto space-y-3 md:space-y-5 flex flex-col items-center">
            <h3 className="bg-black p-2 md:p-5 text-white rounded-3xl font-bold text-2xl md:text-5xl">Log In!</h3>
            <form onSubmit={handleLogIn} className="md:w-2/3 lg:w-1/2 border border-gray-400 md:m-7  p-3 md:p-7 rounded-3xl">
                ...
                <input className="w-full mt-1 mb-2 md:mb-5 border border-gray-400 py-2 px-3 rounded-xl outline-none" type="password" name="password" placeholder="Type a Password" required />
            ...
            <p className="text-sm sm:text-base md:text-lg">New Here? Please <Link className="underline font-medium text-black" to="/register">Register</Link></p>
            <div className='h-1 w-40 mx-auto bg-black'></div>
        </div>
    );
};
